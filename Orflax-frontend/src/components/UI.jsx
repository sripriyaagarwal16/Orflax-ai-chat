  ...
  return (
    <>
      <div className="fixed top-0 left-0 right-0 bottom-0 z-10 flex justify-between p-4 flex-col pointer-events-none">
        {/* Header */}
        <div className="self-start backdrop-blur-md bg-yellow-100 bg-opacity-80 p-4 rounded-lg shadow-md border border-yellow-300">
          <h1 className="font-black text-xl text-gray-800">AskOrflax</h1>
          <p className="text-gray-700">
            Wired to Answer, Powered by Orflax. 😊
          </p>
        </div>
        ...
        <div className="w-full flex flex-col items-end justify-center gap-4">
          ...
          <button
            ...
            className="pointer-events-auto bg-yellow-400 hover:bg-yellow-500 text-gray-900 p-4 rounded-md shadow"
          >
            {cameraZoomed ? (
              <svg
